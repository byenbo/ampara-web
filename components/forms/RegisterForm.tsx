  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <div className="text-center mb-8">
        <h1 className="font-display font-bold text-2xl text-primary-900 mb-2">Crea tu cuenta</h1>
        <p className="text-neutral-500 text-sm">Únete a Ampara. Es gratis y sin compromisos.</p>
      </div>
